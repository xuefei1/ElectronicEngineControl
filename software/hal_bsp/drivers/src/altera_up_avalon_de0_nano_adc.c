...
#define read_ch0(adc)  IORD_ALT_UP_DE0_NANO_ADC_CH_0(((adc)->base))
#define read_ch1(adc)  IORD_ALT_UP_DE0_NANO_ADC_CH_1(((adc)->base))
#define read_ch2(adc)  IORD_ALT_UP_DE0_NANO_ADC_CH_2(((adc)->base))
#define read_ch3(adc)  IORD_ALT_UP_DE0_NANO_ADC_CH_3(((adc)->base))
