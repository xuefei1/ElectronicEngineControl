...
generic_tristate_controller_0: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory2_0
MEM_1 := niosII_system_onchip_memory2_0
...
$(MEM_1)_START := 0x01104000
$(MEM_1)_END := 0x01107fff
